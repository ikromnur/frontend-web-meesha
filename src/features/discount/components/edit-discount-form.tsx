...
import { useUpdateDiscount } from "@/features/discount/api/use-update-discount";
...
export const EditDiscountForm = ({
  discount,
  onClose,
}: EditDiscountFormProps) => {
  const mutation = useUpdateDiscount(discount.id);

  const defaultStart =
    discount.startDateMs !== undefined
      ? new Date(discount.startDateMs)
      : discount.startDate
      ...
      : undefined;
  const defaultEnd =
    discount.endDateMs !== undefined
      ? new Date(discount.endDateMs)
      : discount.endDate
  ...
  const form = useForm<DiscountFormValues>({
    ...
    defaultValues: {
      ...
      type: discount.type as DiscountFormValues["type"],
